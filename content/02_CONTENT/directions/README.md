...
Short-form hook bank and posting direction for MySleepLabs.

This folder is **not** a carousel drop. Do not run the L0 critic over it as if these were `carousel-NN-*.md` files. Hooks here are raw openers. A finished Reel, Pin, or carousel still has to pass critic after you write the body, caption, and sources.
